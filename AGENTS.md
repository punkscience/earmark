...
- Built-in relay defaults: `relay.damus.io`, `nos.lol`, `relay.primal.net`, `nostr.wine`
- Built-in Blossom server defaults: `blossom.band`, `cdn.satellite.earth`, `nostr.build`
